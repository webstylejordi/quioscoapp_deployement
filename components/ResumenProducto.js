...
const ResumenProducto = ({producto}) => {
  ...
  return (
    <div className='shadow p-5 mb-5 flex gap-10 items-center'>{producto.nombre}
          ...
          <div>
               <button
                    ...
                    font-bold uppercase shadow-md w-full lg:w-auto" 
                    onClick={ () => handleEditarCantidades(producto.id)}
               >
                    <svg xmlns="http://www.w3.org/2000/svg" 
                         className="h-5 w-5  gap-2 " 
                         viewBox="0 0 20 20"
                         fill="currentColor">
               ...
               <button
                    type='button'
                    className="bg-red-700 flex px-5 py-2 mt-5 gap-2 text-white rounded-md 
                    font-bold uppercase shadow-md w-full lg:w-auto" 
               ...
               >
                    <svg xmlns="http://www.w3.org/2000/svg" 
                         ...
                         <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2
                          2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012
                           0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    Eliminar
               </button>
          </div>
